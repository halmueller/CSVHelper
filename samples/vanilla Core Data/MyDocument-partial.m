...
{
Australianpostcodes *theInstance = (Australianpostcodes *)[NSEntityDescription insertNewObjectForEntityForName:Australianpostcodes inManagedObjectContext:self.managedObjectContext];
